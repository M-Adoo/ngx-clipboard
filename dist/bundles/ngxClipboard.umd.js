(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/platform-browser'), require('ngx-window-token/index'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/platform-browser', 'ngx-window-token/index', '@angular/common'], factory) :
	(factory((global.ngx = global.ngx || {}, global.ngx.clipboard = global.ngx.clipboard || {}),global.ng.core,global._angular_platformBrowser,global.ngxWindowToken_index,global.ng.common));
}(this, (function (exports,_angular_core,_angular_platformBrowser,ngxWindowToken_index,_angular_common) { 'use strict';
...
ClipboardService.ctorParameters = function () { return [
    ...
    { type: undefined, decorators: [{ type: _angular_core.Inject, args: [ngxWindowToken_index.WINDOW,] },] },
]; };
/**
 * @param {?} doc
 * @param {?} win
...
var CLIPBOARD_SERVICE_PROVIDER = {
    ...
    deps: [_angular_platformBrowser.DOCUMENT, ngxWindowToken_index.WINDOW, [new _angular_core.Optional(), new _angular_core.SkipSelf(), ClipboardService]],
...
ClipboardModule.decorators = [
    { type: _angular_core.NgModule, args: [{
                imports: [_angular_common.CommonModule, ngxWindowToken_index.WindowTokenModule],
